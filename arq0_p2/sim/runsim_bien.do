--------------------------------------------------------------------------------
# Script ModelSim para la simulacion del procesador Arq2019-2020
--------------------------------------------------------------------------------
...
vcom -work work -2002 -explicit -check_synthesis ../rtl/control_unit_bien.vhd
vcom -work work -2002 -explicit -check_synthesis ../rtl/processor_bien.vhd
